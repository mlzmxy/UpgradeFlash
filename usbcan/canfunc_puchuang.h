...
typedef bool(__stdcall* Func_PuChuang_3)(DWORD, DWORD, PVCI_INIT_CONFIG);
typedef bool(__stdcall* Func_PuChuang_4)(DWORD, DWORD, PVCI_CAN_OBJ);
typedef bool(__stdcall* Func_PuChuang_5)(DWORD, PCHAR);
typedef DWORD(__stdcall* Func_PuChuang_6)(DWORD, DWORD, PVCI_CAN_OBJ, DWORD, INT);
